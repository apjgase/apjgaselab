...
echo "host    all             all              0.0.0.0/0                       password" | sudo tee -a /var/lib/pgsql/9.6/data/pg_hba.conf
echo "host    all             all              ::/0                            password" | sudo tee -a /var/lib/pgsql/9.6/data/pg_hba.conf
...
sudo -u postgres psql -U postgres -d postgres -c "alter user postgres with password 'nutanix';"
